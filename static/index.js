(function() {
  ...
  function setupWindow() {
    ...
    const Grim = useSnapshot ? snapshotResult.customRequire('../node_modules/grim/lib/grim.js') : require('grim')
    const documentRegisterElement = document.registerElement

    document.registerElement = (type, options) => {
      Grim.deprecate('Use `customElements.define` instead of `document.registerElement` see https://javascript.info/custom-elements')
